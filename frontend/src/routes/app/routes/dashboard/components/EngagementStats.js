    ...
    return(
        <div className="row">
            <div className="col-xl-3 col-lg-6">
                <ReactEcharts height={200} option={pie1.options} showLoading={false}/>
            </div>
            <div className="col-xl-3 col-lg-6">
                <ReactEcharts height={200} option={pie2.options} showLoading={false}/>
            </div>
            <div className="col-xl-3 col-lg-6">
                <ReactEcharts height={200} option={pie3.options} showLoading={false}/>
            </div>
            <div className="col-xl-3 col-lg-6">
                <ReactEcharts height={200} option={pie4.options} showLoading={false}/>
            </div>
        </div>
    )
}
