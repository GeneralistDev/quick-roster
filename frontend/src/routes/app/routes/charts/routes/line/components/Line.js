            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={line1.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={line2.options} showLoading={false}/>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={line3.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={line4.options} showLoading={false}/>
                        </div>
                    </div>
