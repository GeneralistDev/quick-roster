...
const heatmapData = heatmapDataSource.map(function (item) {
    ...
    return(
        <div className="container-fluid no-breadcrumbs">
            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={gauge1.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={pie5.options} showLoading={false}/>
                        </div>
                    </div>
            ...
            <div className="box box-default">
                ...
                <div className="box-body">
                    <ReactEcharts height={350} option={heatmap1.options} showLoading={false}/>
                </div>
            </div>
