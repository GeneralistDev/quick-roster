            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={bar1.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={bar2.options} showLoading={false}/>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={bar3.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={bar4.options} showLoading={false}/>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-xl-12">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={bar5.options} showLoading={false}/>
                        </div>
                    </div>
