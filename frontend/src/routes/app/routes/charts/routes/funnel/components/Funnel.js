    ...
    return(
        <div className="container-fluid no-breadcrumbs">
            ...
            <div className="row">
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={funnel1.options} showLoading={false}/>
                        </div>
                    </div>
                ...
                <div className="col-xl-6">
                    ...
                    <div className="box box-default">
                        ...
                        <div className="box-body">
                            <ReactEcharts height={350} option={funnel2.options} showLoading={false}/>
                        </div>
                    </div>
            ...
            <div className="box box-default">
                ...
                <div className="box-body">
                    <ReactEcharts height={350} option={funnel3.options} showLoading={false}/>
                </div>
            </div>
