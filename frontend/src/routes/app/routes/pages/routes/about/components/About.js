                        ...
                        <div className="col-xl-9">
                            <div className="row">
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-primary"></span><strong>Strong sense of purpose</strong> <br />We want to help everyone build their brands and identity online.</p>
                                </div>
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-info"></span><strong>Relentless focus on success</strong> <br />Get rid of your excuses. Take pride in getting shit done.</p>
                                </div>
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-success"></span><strong>New ideas on how to do things better</strong> <br />Question everything. Don't fall into the status-quo trap. Innovate!</p>
                                </div>
                            </div>
                            <div className="divider divider-lg"></div>
                            <div className="row">
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-warning"></span><strong>High bar for quality</strong> <br />We're obsessed with building the best and always see room for improvement.</p>
                                </div>
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-danger"></span><strong>Embrace the challenge</strong> <br />Uncertainty is always part of a startup. We tackle big ideas with courage.</p>
                                </div>
                                <div className="col-xl-4">
                                    <p><span className="space-bar bg-color-dark"></span><strong>Simplify</strong> <br />To create the best experience, we cut all distractions and get to the point.</p>
                                </div>
                            </div>
                        </div>
                    </div>
