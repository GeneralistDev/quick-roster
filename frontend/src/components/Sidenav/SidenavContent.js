        ...
        return (
            <ul className="nav" ref="nav">
                ...
                <li>
                    ...
                    <ul>
                        <li><FlatButton className="prepend-icon" href="#/app/form/elements"><span>Form Elements</span><span className="badge badge-pill badge-info">12</span></FlatButton></li>
                ...
                <li className="li-small"><FlatButton href="#/app/form/elements"><i className="nav-icon nav-dot material-icons color-success">fiber_manual_record</i><span className="nav-text">Form Elements</span></FlatButton></li>
